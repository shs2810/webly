var client = function () {
    ...
    } else if (!!ua.match(/Trident\/7.0/) && ua.indexOf("rv:11.0") != -1) {
...
var isES5 = function () {
    if (client.browser.ie) {
        return client.browser.ie >= 9;
    } else if (client.browser.edge) {
        return true;
    } else if (client.browser.chrome) {
        return client.browser.chrome >= 23;
    } else if (client.browser.opera) {
        return client.browser.opera >= 15;
    } else if (client.browser.firefox) {
        return client.browser.firefox >= 21;
    } else if (client.browser.konq) {
        return client.browser.konq != 4.3 || client.browser.konq != 4.9;
    } else if (client.browser.safari) {
        return client.browser.safari >= 6;
    } else {
        return false;
    }
}();
